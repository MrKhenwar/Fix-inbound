  ...
  return (
    <section className="py-20 px-6 bg-ivory">
      <div className="container mx-auto max-w-4xl text-center">
        ...
        <p className="text-base sm:text-lg md:text-xl text-charcoal/60 mb-10">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-8 py-4 bg-primary text-ivory font-semibold rounded-lg hover:bg-primary-dark transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl"
        >
